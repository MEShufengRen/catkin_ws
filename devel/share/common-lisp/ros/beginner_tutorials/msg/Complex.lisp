...
(cl:defmethod cl:initialize-instance :after ((m <Complex>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Complex)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name beginner_tutorials-msg:<Complex> is deprecated: use beginner_tutorials-msg:Complex instead.")))

(cl:ensure-generic-function 'real-val :lambda-list '(m))
(cl:defmethod real-val ((m <Complex>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader beginner_tutorials-msg:real-val is deprecated.  Use beginner_tutorials-msg:real instead.")
  (real m))

(cl:ensure-generic-function 'imaginary-val :lambda-list '(m))
(cl:defmethod imaginary-val ((m <Complex>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader beginner_tutorials-msg:imaginary-val is deprecated.  Use beginner_tutorials-msg:imaginary instead.")
  (imaginary m))
